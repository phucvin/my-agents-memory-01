...
(func $@username/moonbit_examples/cmd/generics.Box::new|String| (param $value/289 (ref $moonbit.string)) (result (ref $Box<String>))
 (struct.new $Box<String>
  (local.get $value/289)))
(func $@username/moonbit_examples/cmd/generics.Box::new|Int| (param $value/288 i32) (result (ref $Box<Int>))
 (struct.new $Box<Int>
  (local.get $value/288)))
...
(func $@moonbitlang/core/builtin.Show::@moonbitlang/core/builtin.SourceLocRepr::output (param $self/249 (ref $@moonbitlang/core/builtin.SourceLocRepr)) (param $logger/285 (ref $@moonbitlang/core/builtin.Logger)) (result i32)
 ...
 (local $*p/431 i32)
 (local $*p/434 i32)
 (local $*bind/468 (ref $@moonbitlang/core/builtin.Logger))
 (local $*bind/469 (ref $@moonbitlang/core/builtin.Logger))
 (local $*bind/470 (ref $moonbit.enum))
 (local $*bind/471 (ref $moonbit.enum))
 (local $tag/477 i32)
 (local $tag/479 i32)
              ...
              (loop $loop:270 (result (ref $<StringView*Option<StringView>>))
               ...
               (if (result (ref $<StringView*Option<StringView>>))
                (i32.lt_s
                 ...
                 (local.get $*end/252))
                (then
                 (block $outer/474 (result (ref $<StringView*Option<StringView>>))
                  (block $join:269
                   (local.set $*p/413
                    (local.get $*cursor/253))
                         ...
                         (loop $loop:273 (result (ref $<StringView*Option<StringView>>))
                          (if (result (ref $<StringView*Option<StringView>>))
                           (i32.lt_s
                            ...
                            (local.get $*end/252))
                           (then
                            (block $outer/475 (result (ref $<StringView*Option<StringView>>))
                             (block $join:272
                              (local.set $*p/416
                               (local.get $*cursor/253))
...
(func $@moonbitlang/core/builtin.Logger::$default_impl::write_substring|@moonbitlang/core/builtin.StringBuilder| (param $self/154 (ref $@moonbitlang/core/builtin.StringBuilder)) (param $value/157 (ref $moonbit.string)) (param $start/158 i32) (param $len/159 i32) (result i32)
 ...
 (local $*bind/467 (ref $moonbit.enum))
 (local $tag/481 i32)
 (local.get $self/154)
 (block $outer/480 (result (ref $StringView))
...
(func $@moonbitlang/core/builtin.SourceLocRepr::parse (param $repr/48 (ref $moonbit.string)) (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
 ...
 (local $*bind/466 (ref $moonbit.enum))
 (local $tag/509 i32)
 (local $tag/511 i32)
 (local $tag/513 i32)
 (local $tag/515 i32)
   ...
   (block $outer/484 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
    (block $join:90
     (block $outer/485 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
      (block $join:94
       (block $switch_int/496 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
        (block $switch_default/497
         (block $switch_int_1/499
          (block $switch_int_7/505
           (block $switch_int_6/504
            (block $switch_int_5/503
             (block $switch_int_4/502
              (block $switch_int_8/506
               (block $switch_int_0/498
                (block $switch_int_2/500
                 (block $switch_int_3/501
           ...
           (if (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
            (i32.lt_s
             ...
             (local.get $*end/51))
            (then
             (block $outer/494 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
              (block $join:112
               (local.set $*p/368
                (local.get $*cursor/52))
    ...
    (if (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
     (i32.lt_s
      ...
      (local.get $*end/51))
     (then
      (block $outer/507 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
       (block $join:91
        (local.set $*p/377
         (local.get $*cursor/52))
 ...
 (if (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
  (i32.eq
   ...
   (i32.const 0))
  (then
   (block $outer/518 (result (ref $StringView))
...
(func $Bytes::to_unchecked_string.inner (param $self/20 (ref $moonbit.bytes)) (param $offset/24 i32) (param $length/22 i64) (result (ref $moonbit.string))
 ...
 (if (result (ref $moonbit.string))
  ...
  (else
   (unreachable))))
(func $moonbitlang/core/builtin.unsafe_sub_string (param $*param/444 (ref $moonbit.bytes)) (param $*param/445 i32) (param $*param/446 i32) (result (ref $moonbit.string))
...
(func $moonbitlang/core/abort.abort|Unit| (param $msg/1 (ref $moonbit.string)) (result i32)
 (unreachable))
(func $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_char.dyncall_as_@moonbitlang/core/builtin.Logger (type $@moonbitlang/core/builtin.Logger.method_3) (param $*obj/460 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/459 i32) (result i32)
 (local $*self/458 (ref $@moonbitlang/core/builtin.StringBuilder))
  ...
  (local.tee $*self/458
   (struct.get $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger 4
    (ref.cast (ref $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger)
     (local.get $*obj/460))))
  (local.get $*param/459)))
(func $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_view.dyncall_as_@moonbitlang/core/builtin.Logger (type $@moonbitlang/core/builtin.Logger.method_2) (param $*obj/457 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/456 (ref $StringView)) (result i32)
 (local $*self/455 (ref $@moonbitlang/core/builtin.StringBuilder))
 (call $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_view
  (local.tee $*self/455
   (struct.get $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger 4
    (ref.cast (ref $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger)
     (local.get $*obj/457))))
  (local.get $*param/456)))
(func $@moonbitlang/core/builtin.Logger::$default_impl::write_substring.dyncall_as_@moonbitlang/core/builtin.Logger|@moonbitlang/core/builtin.StringBuilder| (type $@moonbitlang/core/builtin.Logger.method_1) (param $*obj/454 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/451 (ref $moonbit.string)) (param $*param/452 i32) (param $*param/453 i32) (result i32)
 (local $*self/450 (ref $@moonbitlang/core/builtin.StringBuilder))
 (call $@moonbitlang/core/builtin.Logger::$default_impl::write_substring|@moonbitlang/core/builtin.StringBuilder|
  ...
  (local.get $*param/452)
  (local.get $*param/453)))
(func $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_string.dyncall_as_@moonbitlang/core/builtin.Logger (type $@moonbitlang/core/builtin.Logger.method_0) (param $*obj/449 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/448 (ref $moonbit.string)) (result i32)
 (local $*self/447 (ref $@moonbitlang/core/builtin.StringBuilder))
 (call $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_string
  ...
  (local.get $*param/448)))
(func $*main*/1
 (local $int_box/292 (ref $Box<Int>))
 (local $str_box/293 (ref $Box<String>))
