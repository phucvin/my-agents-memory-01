...
(func $@username/moonbit_examples/cmd/generics.Box::new|String| (param $value/316 (ref $moonbit.string)) (result (ref $Box<String>))
 (struct.new $Box<String>
  (local.get $value/316)))
(func $@username/moonbit_examples/cmd/generics.Box::new|Int| (param $value/315 i32) (result (ref $Box<Int>))
 (struct.new $Box<Int>
  (local.get $value/315)))
...
(func $@moonbitlang/core/builtin.Show::@moonbitlang/core/builtin.SourceLocRepr::output (param $self/299 (ref $@moonbitlang/core/builtin.SourceLocRepr)) (param $logger/312 (ref $@moonbitlang/core/builtin.Logger)) (result i32)
 ...
 (local $*bind/480 (ref $@moonbitlang/core/builtin.Logger))
 (local $*bind/481 (ref $@moonbitlang/core/builtin.Logger))
...
(func $@moonbitlang/core/builtin.Logger::$default_impl::write_substring|@moonbitlang/core/builtin.StringBuilder| (param $self/172 (ref $@moonbitlang/core/builtin.StringBuilder)) (param $value/175 (ref $moonbit.string)) (param $start/176 i32) (param $len/177 i32) (result i32)
 ...
 (local $*bind/479 (ref $moonbit.enum))
 (local $tag/483 i32)
 (local.get $self/172)
 (block $outer/482 (result (ref $StringView))
...
(func $Bytes::to_unchecked_string.inner (param $self/26 (ref $moonbit.bytes)) (param $offset/30 i32) (param $length/28 i64) (result (ref $moonbit.string))
 ...
 (if (result (ref $moonbit.string))
  ...
  (else
   (unreachable))))
(func $moonbitlang/core/builtin.unsafe_sub_string (param $*param/462 (ref $moonbit.bytes)) (param $*param/463 i32) (param $*param/464 i32) (result (ref $moonbit.string))
...
(func $moonbitlang/core/abort.abort|Unit| (param $msg/1 (ref $moonbit.string)) (result i32)
 (unreachable))
(func $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_char.dyncall_as_@moonbitlang/core/builtin.Logger (type $@moonbitlang/core/builtin.Logger.method_3) (param $*obj/478 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/477 i32) (result i32)
  ...
  (local.tee $*self/476
   (struct.get $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger 4
    (ref.cast (ref $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger)
     (local.get $*obj/478))))
  (local.get $*param/477)))
(func $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_view.dyncall_as_@moonbitlang/core/builtin.Logger (type $@moonbitlang/core/builtin.Logger.method_2) (param $*obj/475 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/474 (ref $StringView)) (result i32)
 (local $*self/473 (ref $@moonbitlang/core/builtin.StringBuilder))
 (call $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_view
  (local.tee $*self/473
   (struct.get $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger 4
    (ref.cast (ref $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger)
     (local.get $*obj/475))))
  (local.get $*param/474)))
(func $@moonbitlang/core/builtin.Logger::$default_impl::write_substring.dyncall_as_@moonbitlang/core/builtin.Logger|@moonbitlang/core/builtin.StringBuilder| (type $@moonbitlang/core/builtin.Logger.method_1) (param $*obj/472 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/469 (ref $moonbit.string)) (param $*param/470 i32) (param $*param/471 i32) (result i32)
 ...
 (call $@moonbitlang/core/builtin.Logger::$default_impl::write_substring|@moonbitlang/core/builtin.StringBuilder|
  ...
  (local.get $*param/470)
  (local.get $*param/471)))
(func $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_string.dyncall_as_@moonbitlang/core/builtin.Logger (type $@moonbitlang/core/builtin.Logger.method_0) (param $*obj/467 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/466 (ref $moonbit.string)) (result i32)
 (local $*self/465 (ref $@moonbitlang/core/builtin.StringBuilder))
...
(func $*init*/2
 ...
 (global.set $moonbitlang/core/builtin.brute_force_find.constr/69
  (i64.extend_i32_s
   (i32.const 0))))
(func $*main*/1
 (local $int_box/319 (ref $Box<Int>))
 (local $str_box/320 (ref $Box<String>))
