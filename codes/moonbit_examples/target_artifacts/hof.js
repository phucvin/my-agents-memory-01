...
function username$moonbit_examples$cmd$hof$$apply(f, x) {
  return f(x);
}
function username$moonbit_examples$cmd$hof$$_init$42$46$double$124$2(x) {
  return Math.imul(x, 2) | 0;
}
function username$moonbit_examples$cmd$hof$$_init$42$46$square$124$4(x) {
  return Math.imul(x, x) | 0;
}
(() => {
  moonbitlang$core$builtin$$println$5$(`Apply double to 5: ${moonbitlang$core$builtin$$Show$to_string$2$(username$moonbit_examples$cmd$hof$$apply(username$moonbit_examples$cmd$hof$$_init$42$46$double$124$2, 5))}`);
  moonbitlang$core$builtin$$println$5$(`Apply square to 5: ${moonbitlang$core$builtin$$Show$to_string$2$(username$moonbit_examples$cmd$hof$$apply(username$moonbit_examples$cmd$hof$$_init$42$46$square$124$4, 5))}`);
})();
