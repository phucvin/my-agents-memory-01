...
(() => {
  const _p = 10;
  const _p$2 = 2;
  const _bind = _p$2 === 0 ? undefined : _p / _p$2 | 0;
  if (_bind === undefined) {
    moonbitlang$core$builtin$$println$5$("Cannot divide by zero");
  } else {
    const _Some = _bind;
    const _v = _Some;
    moonbitlang$core$builtin$$println$5$(`${moonbitlang$core$builtin$$Show$to_string$2$(10)} / ${moonbitlang$core$builtin$$Show$to_string$2$(2)} = ${moonbitlang$core$builtin$$Show$to_string$2$(_v)}`);
  }
  const _p$3 = 10;
  const _p$4 = 0;
  const _bind$2 = _p$4 === 0 ? undefined : _p$3 / _p$4 | 0;
  if (_bind$2 === undefined) {
    ...
    const _Some = _bind$2;
    const _v = _Some;
    moonbitlang$core$builtin$$println$5$(`${moonbitlang$core$builtin$$Show$to_string$2$(10)} / ${moonbitlang$core$builtin$$Show$to_string$2$(0)} = ${moonbitlang$core$builtin$$Show$to_string$2$(_v)}`);
    return;
  }
})();
