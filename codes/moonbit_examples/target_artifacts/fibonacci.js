...
function username$moonbit_examples$cmd$fibonacci$$fib(n) {
  return n <= 1 ? n : username$moonbit_examples$cmd$fibonacci$$fib(n - 1 | 0) + username$moonbit_examples$cmd$fibonacci$$fib(n - 2 | 0) | 0;
}
(() => {
  moonbitlang$core$builtin$$println$5$(`Fibonacci of ${moonbitlang$core$builtin$$Show$to_string$2$(10)} is ${moonbitlang$core$builtin$$Show$to_string$2$(username$moonbit_examples$cmd$fibonacci$$fib(10))}`);
})();
