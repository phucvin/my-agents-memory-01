...
(func $@moonbitlang/core/builtin.Show::@moonbitlang/core/builtin.SourceLocRepr::output (param $self/249 (ref $@moonbitlang/core/builtin.SourceLocRepr)) (param $logger/285 (ref $@moonbitlang/core/builtin.Logger)) (result i32)
 ...
 (local $*p/433 i32)
 (local $*p/436 i32)
 (local $*bind/471 (ref $@moonbitlang/core/builtin.Logger))
 (local $*bind/472 (ref $@moonbitlang/core/builtin.Logger))
 (local $*bind/473 (ref $moonbit.enum))
 (local $*bind/474 (ref $moonbit.enum))
 (local $tag/480 i32)
 (local $tag/482 i32)
 ...
 (block $outer/475 (result (ref $<StringView*Option<StringView>>))
   ...
   (loop $loop:267 (result (ref $<StringView*Option<StringView>>))
    (if (result (ref $<StringView*Option<StringView>>))
     (i32.lt_s
      ...
      (local.get $*end/252))
     (then
      (block $outer/476 (result (ref $<StringView*Option<StringView>>))
       (block $join:266
        (local.set $*p/412
         (local.get $*cursor/253))
              ...
              (loop $loop:270 (result (ref $<StringView*Option<StringView>>))
               ...
               (if (result (ref $<StringView*Option<StringView>>))
                (i32.lt_s
                 ...
                 (local.get $*end/252))
                (then
                 (block $outer/477 (result (ref $<StringView*Option<StringView>>))
                  (block $join:269
                   (local.set $*p/415
                    (local.get $*cursor/253))
                         ...
                         (loop $loop:273 (result (ref $<StringView*Option<StringView>>))
                          (if (result (ref $<StringView*Option<StringView>>))
                           (i32.lt_s
                            ...
                            (local.get $*end/252))
                           (then
                            (block $outer/478 (result (ref $<StringView*Option<StringView>>))
                             (block $join:272
                              (local.set $*p/418
                               (local.get $*cursor/253))
  ...
  (if (result (ref $<StringView*Option<StringView>>))
   (i32.eq
    ...
    (i32.const 0))
   (then
    (block $outer/481 (result (ref $StringView))
    ...
    (block $outer/479 (result (ref $StringView))
...
(func $@moonbitlang/core/builtin.Logger::$default_impl::write_substring|@moonbitlang/core/builtin.StringBuilder| (param $self/154 (ref $@moonbitlang/core/builtin.StringBuilder)) (param $value/157 (ref $moonbit.string)) (param $start/158 i32) (param $len/159 i32) (result i32)
 ...
 (local $tag/484 i32)
 (local.get $self/154)
 (block $outer/483 (result (ref $StringView))
...
(func $@moonbitlang/core/builtin.SourceLocRepr::parse (param $repr/48 (ref $moonbit.string)) (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
   ...
   (block $outer/487 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
    (block $join:90
     (block $outer/488 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
      (block $join:94
       (block $switch_int/499 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
        (block $switch_default/500
         (block $switch_int_1/502
          (block $switch_int_7/508
           (block $switch_int_6/507
            (block $switch_int_5/506
             (block $switch_int_4/505
              (block $switch_int_8/509
               (block $switch_int_0/501
                (block $switch_int_2/503
                 (block $switch_int_3/504
            ...
            (if (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
             (i32.lt_s
              ...
              (local.get $*end/51))
             (then
              (block $outer/496 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
               (block $join:110
                (local.set $*p/367
                 (local.get $*cursor/52))
           ...
           (if (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
            (i32.lt_s
             ...
             (local.get $*end/51))
            (then
             (block $outer/497 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
              (block $join:112
               (local.set $*p/370
                (local.get $*cursor/52))
         ...
         (if (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
          (i32.lt_s
           ...
           (local.get $*end/51))
          (then
           (block $outer/498 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
            (block $join:115
             (local.set $*p/376
              (local.get $*cursor/52))
    ...
    (if (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
     (i32.lt_s
      ...
      (local.get $*end/51))
     (then
      (block $outer/510 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
       (block $join:91
        (local.set $*p/379
         (local.get $*cursor/52))
 ...
 (if (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
  (i32.eq
   ...
   (i32.const 0))
  (then
   (block $outer/521 (result (ref $StringView))
   ...
   (block $outer/519 (result (ref $StringView))
   ...
   (block $outer/517 (result (ref $StringView))
    ...
    (unreachable))
   (local.set $pkg/75)
   (block $outer/515 (result (ref $StringView))
   ...
   (block $outer/513 (result (ref $StringView))
...
(func $Bytes::to_unchecked_string.inner (param $self/20 (ref $moonbit.bytes)) (param $offset/24 i32) (param $length/22 i64) (result (ref $moonbit.string))
 ...
 (if (result (ref $moonbit.string))
  ...
  (else
   (unreachable))))
(func $moonbitlang/core/builtin.unsafe_sub_string (param $*param/447 (ref $moonbit.bytes)) (param $*param/448 i32) (param $*param/449 i32) (result (ref $moonbit.string))
...
(func $moonbitlang/core/abort.abort|Unit| (param $msg/1 (ref $moonbit.string)) (result i32)
 (unreachable))
(func $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_char.dyncall_as_@moonbitlang/core/builtin.Logger (type $@moonbitlang/core/builtin.Logger.method_3) (param $*obj/463 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/462 i32) (result i32)
 (local $*self/461 (ref $@moonbitlang/core/builtin.StringBuilder))
  ...
  (local.tee $*self/461
   (struct.get $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger 4
    (ref.cast (ref $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger)
     (local.get $*obj/463))))
  (local.get $*param/462)))
(func $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_view.dyncall_as_@moonbitlang/core/builtin.Logger (type $@moonbitlang/core/builtin.Logger.method_2) (param $*obj/460 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/459 (ref $StringView)) (result i32)
  ...
  (local.tee $*self/458
   (struct.get $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger 4
    (ref.cast (ref $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger)
     (local.get $*obj/460))))
  (local.get $*param/459)))
(func $@moonbitlang/core/builtin.Logger::$default_impl::write_substring.dyncall_as_@moonbitlang/core/builtin.Logger|@moonbitlang/core/builtin.StringBuilder| (type $@moonbitlang/core/builtin.Logger.method_1) (param $*obj/457 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/454 (ref $moonbit.string)) (param $*param/455 i32) (param $*param/456 i32) (result i32)
 ...
 (call $@moonbitlang/core/builtin.Logger::$default_impl::write_substring|@moonbitlang/core/builtin.StringBuilder|
  ...
  (local.get $*param/455)
  (local.get $*param/456)))
(func $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_string.dyncall_as_@moonbitlang/core/builtin.Logger (type $@moonbitlang/core/builtin.Logger.method_0) (param $*obj/452 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/451 (ref $moonbit.string)) (result i32)
