...
(func $username/moonbit_examples/cmd/factorial.factorial (param $n/290 i32) (result i32)
 (local $i/289 i32)
 (local $result/288 i32)
 (local.set $result/288
  (i32.const 1))
 (i32.const 1)
 (loop $loop:291 (param i32)
  (local.tee $i/289)
  (local.get $n/290)
  (i32.le_s)
  (if
 ...
 (block $outer/463 (result (ref $<StringView*Option<StringView>>))
   ...
   (loop $loop:267 (result (ref $<StringView*Option<StringView>>))
    (if (result (ref $<StringView*Option<StringView>>))
     (i32.lt_s
      ...
      (local.get $*end/252))
     (then
      (block $outer/464 (result (ref $<StringView*Option<StringView>>))
       (block $join:266
        (local.set $*p/408
         (local.get $*cursor/253))
  ...
  (if (result (ref $<StringView*Option<StringView>>))
   ...
   (then
    ...
    (block $outer/467 (result (ref $StringView))
...
(func $@moonbitlang/core/builtin.SourceLocRepr::parse (param $repr/48 (ref $moonbit.string)) (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
   ...
   (block $outer/475 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
    (block $join:90
     (block $outer/476 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
      (block $join:94
       (block $switch_int/487 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
        (block $switch_default/488
         (block $switch_int_1/490
          (block $switch_int_7/496
           (block $switch_int_6/495
            (block $switch_int_5/494
             (block $switch_int_4/493
              (block $switch_int_8/497
               (block $switch_int_0/489
                (block $switch_int_2/491
                 (block $switch_int_3/492
 ...
 (if (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
  ...
  (then
   ...
   (block $outer/499 (result (ref $StringView))
   ...
   (call $moonbit.add_string
    (call $moonbit.add_string
     ...
     (call $moonbit.string_literal
      ...
      (i32.const 4)))
    (call $@moonbitlang/core/builtin.Show::$default_impl::to_string|Int|
     (call $username/moonbit_examples/cmd/factorial.factorial
      (i32.const 5)))))))
