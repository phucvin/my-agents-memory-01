...
(func $username/moonbit_examples/cmd/hof.*init*.square|4.dyncall (type $<Int>=>Int-sig) (param $*env/474 (ref $<Int>=>Int)) (param $x/318 i32) (result i32)
 (call $username/moonbit_examples/cmd/hof.*init*.square|4
  (local.get $x/318)))
(func $username/moonbit_examples/cmd/hof.*init*.double|2.dyncall (type $<Int>=>Int-sig) (param $*env/473 (ref $<Int>=>Int)) (param $x/317 i32) (result i32)
...
(func $username/moonbit_examples/cmd/hof.*init*.double|2 (param $x/317 i32) (result i32)
 (i32.mul
  (local.get $x/317)
  (i32.const 2)))
(func $username/moonbit_examples/cmd/hof.apply (param $f/315 (ref $<Int>=>Int)) (param $x/316 i32) (result i32)
...
(func $@moonbitlang/core/builtin.Logger::$default_impl::write_substring|@moonbitlang/core/builtin.StringBuilder| (param $self/172 (ref $@moonbitlang/core/builtin.StringBuilder)) (param $value/175 (ref $moonbit.string)) (param $start/176 i32) (param $len/177 i32) (result i32)
 ...
 (local $tag/476 i32)
 (local.get $self/172)
 (block $outer/475 (result (ref $StringView))
...
(func $Bytes::to_unchecked_string.inner (param $self/26 (ref $moonbit.bytes)) (param $offset/30 i32) (param $length/28 i64) (result (ref $moonbit.string))
 ...
 (if (result (ref $moonbit.string))
  ...
  (else
   (unreachable))))
(func $moonbitlang/core/builtin.unsafe_sub_string (param $*param/453 (ref $moonbit.bytes)) (param $*param/454 i32) (param $*param/455 i32) (result (ref $moonbit.string))
...
(func $moonbitlang/core/abort.abort|Unit| (param $msg/1 (ref $moonbit.string)) (result i32)
 (unreachable))
(func $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_char.dyncall_as_@moonbitlang/core/builtin.Logger (type $@moonbitlang/core/builtin.Logger.method_3) (param $*obj/469 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/468 i32) (result i32)
 (local $*self/467 (ref $@moonbitlang/core/builtin.StringBuilder))
  ...
  (local.tee $*self/467
   (struct.get $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger 4
    (ref.cast (ref $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger)
     (local.get $*obj/469))))
  (local.get $*param/468)))
(func $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_view.dyncall_as_@moonbitlang/core/builtin.Logger (type $@moonbitlang/core/builtin.Logger.method_2) (param $*obj/466 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/465 (ref $StringView)) (result i32)
 (local $*self/464 (ref $@moonbitlang/core/builtin.StringBuilder))
 (call $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_view
  (local.tee $*self/464
   (struct.get $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger 4
    (ref.cast (ref $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger)
     (local.get $*obj/466))))
  (local.get $*param/465)))
(func $@moonbitlang/core/builtin.Logger::$default_impl::write_substring.dyncall_as_@moonbitlang/core/builtin.Logger|@moonbitlang/core/builtin.StringBuilder| (type $@moonbitlang/core/builtin.Logger.method_1) (param $*obj/463 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/460 (ref $moonbit.string)) (param $*param/461 i32) (param $*param/462 i32) (result i32)
 (local $*self/459 (ref $@moonbitlang/core/builtin.StringBuilder))
 (call $@moonbitlang/core/builtin.Logger::$default_impl::write_substring|@moonbitlang/core/builtin.StringBuilder|
  ...
  (local.get $*param/461)
  (local.get $*param/462)))
(func $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_string.dyncall_as_@moonbitlang/core/builtin.Logger (type $@moonbitlang/core/builtin.Logger.method_0) (param $*obj/458 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/457 (ref $moonbit.string)) (result i32)
