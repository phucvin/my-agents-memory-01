...
(elem
 declare
 func
 $username/moonbit_examples/cmd/hof.*init*.square|4.dyncall
 $username/moonbit_examples/cmd/hof.*init*.double|2.dyncall
...
(global $username/moonbit_examples/cmd/hof.*init*.double|2
 (mut (ref null $<Int>=>Int))
 (ref.null $<Int>=>Int)
)
(global $username/moonbit_examples/cmd/hof.*init*.square|4
 (mut (ref null $<Int>=>Int))
 (ref.null $<Int>=>Int)
)
...
(func $username/moonbit_examples/cmd/hof.*init*.square|4.dyncall (type $<Int>=>Int-sig) (param $*env/464 (ref $<Int>=>Int)) (param $x/291 i32) (result i32)
 (call $username/moonbit_examples/cmd/hof.*init*.square|4
  (local.get $x/291)))
(func $username/moonbit_examples/cmd/hof.*init*.double|2.dyncall (type $<Int>=>Int-sig) (param $*env/463 (ref $<Int>=>Int)) (param $x/290 i32) (result i32)
...
(func $username/moonbit_examples/cmd/hof.*init*.double|2 (param $x/290 i32) (result i32)
 (i32.mul
  (local.get $x/290)
  (i32.const 2)))
(func $username/moonbit_examples/cmd/hof.apply (param $f/288 (ref $<Int>=>Int)) (param $x/289 i32) (result i32)
...
(func $@moonbitlang/core/builtin.Show::@moonbitlang/core/builtin.SourceLocRepr::output (param $self/249 (ref $@moonbitlang/core/builtin.SourceLocRepr)) (param $logger/285 (ref $@moonbitlang/core/builtin.Logger)) (result i32)
 ...
 (local $*p/429 i32)
 (local $*p/432 i32)
 (local $*bind/459 (ref $@moonbitlang/core/builtin.Logger))
 (local $*bind/460 (ref $@moonbitlang/core/builtin.Logger))
 ...
 (local.set $tag_0/257
  (i32.const -1))
 (block $outer/465 (result (ref $<StringView*Option<StringView>>))
  (block $join:259
   (loop $loop:267 (result (ref $<StringView*Option<StringView>>))
    (if (result (ref $<StringView*Option<StringView>>))
     (i32.lt_s
      ...
      (local.get $*end/252))
     (then
      (block $outer/466 (result (ref $<StringView*Option<StringView>>))
       (block $join:266
        (local.set $*p/408
         (local.get $*cursor/253))
              ...
              (loop $loop:270 (result (ref $<StringView*Option<StringView>>))
               ...
               (if (result (ref $<StringView*Option<StringView>>))
                (i32.lt_s
                 ...
                 (local.get $*end/252))
                (then
                 (block $outer/467 (result (ref $<StringView*Option<StringView>>))
                  (block $join:269
                   (local.set $*p/411
                    (local.get $*cursor/253))
                         ...
                         (loop $loop:273 (result (ref $<StringView*Option<StringView>>))
                          (if (result (ref $<StringView*Option<StringView>>))
                           (i32.lt_s
                            ...
                            (local.get $*end/252))
                           (then
                            (block $outer/468 (result (ref $<StringView*Option<StringView>>))
                             (block $join:272
                              (local.set $*p/414
                               (local.get $*cursor/253))
  ...
  (if (result (ref $<StringView*Option<StringView>>))
   (i32.eq
    ...
    (i32.const 0))
   (then
    (block $outer/471 (result (ref $StringView))
    ...
    (block $outer/469 (result (ref $StringView))
...
(func $@moonbitlang/core/builtin.Logger::$default_impl::write_substring|@moonbitlang/core/builtin.StringBuilder| (param $self/154 (ref $@moonbitlang/core/builtin.StringBuilder)) (param $value/157 (ref $moonbit.string)) (param $start/158 i32) (param $len/159 i32) (result i32)
 ...
 (local $tag/474 i32)
 (local.get $self/154)
 (block $outer/473 (result (ref $StringView))
...
(func $@moonbitlang/core/builtin.SourceLocRepr::parse (param $repr/48 (ref $moonbit.string)) (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
 ...
 (local $*bind/456 (ref $moonbit.enum))
 (local $*bind/457 (ref $moonbit.enum))
 (local $tag/502 i32)
 (local $tag/504 i32)
 (local $tag/506 i32)
 (local $tag/508 i32)
   ...
   (block $outer/477 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
    (block $join:90
     (block $outer/478 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
      (block $join:94
       (block $switch_int/489 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
        (block $switch_default/490
         (block $switch_int_1/492
          (block $switch_int_7/498
           (block $switch_int_6/497
            (block $switch_int_5/496
             (block $switch_int_4/495
              (block $switch_int_8/499
               (block $switch_int_0/491
                (block $switch_int_2/493
                 (block $switch_int_3/494
    ...
    (if (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
     (i32.lt_s
      ...
      (local.get $*end/51))
     (then
      (block $outer/500 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
       (block $join:91
        (local.set $*p/375
         (local.get $*cursor/52))
 ...
 (if (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
  (i32.eq
   ...
   (i32.const 0))
  (then
   (block $outer/511 (result (ref $StringView))
   ...
   (block $outer/509 (result (ref $StringView))
   ...
   (block $outer/507 (result (ref $StringView))
    ...
    (unreachable))
   (local.set $pkg/75)
   (block $outer/505 (result (ref $StringView))
   ...
   (block $outer/503 (result (ref $StringView))
   ...
   (block $outer/501 (result (ref $StringView))
...
(func $Bytes::to_unchecked_string.inner (param $self/20 (ref $moonbit.bytes)) (param $offset/24 i32) (param $length/22 i64) (result (ref $moonbit.string))
 ...
 (if (result (ref $moonbit.string))
  ...
  (else
   (unreachable))))
(func $moonbitlang/core/builtin.unsafe_sub_string (param $*param/435 (ref $moonbit.bytes)) (param $*param/436 i32) (param $*param/437 i32) (result (ref $moonbit.string))
...
(func $moonbitlang/core/abort.abort|Unit| (param $msg/1 (ref $moonbit.string)) (result i32)
 (unreachable))
(func $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_char.dyncall_as_@moonbitlang/core/builtin.Logger (type $@moonbitlang/core/builtin.Logger.method_3) (param $*obj/451 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/450 i32) (result i32)
 (local $*self/449 (ref $@moonbitlang/core/builtin.StringBuilder))
  ...
  (local.tee $*self/449
   (struct.get $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger 4
    (ref.cast (ref $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger)
     (local.get $*obj/451))))
  (local.get $*param/450)))
(func $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_view.dyncall_as_@moonbitlang/core/builtin.Logger (type $@moonbitlang/core/builtin.Logger.method_2) (param $*obj/448 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/447 (ref $StringView)) (result i32)
  ...
  (local.tee $*self/446
   (struct.get $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger 4
    (ref.cast (ref $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger)
     (local.get $*obj/448))))
  (local.get $*param/447)))
(func $@moonbitlang/core/builtin.Logger::$default_impl::write_substring.dyncall_as_@moonbitlang/core/builtin.Logger|@moonbitlang/core/builtin.StringBuilder| (type $@moonbitlang/core/builtin.Logger.method_1) (param $*obj/445 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/442 (ref $moonbit.string)) (param $*param/443 i32) (param $*param/444 i32) (result i32)
 (local $*self/441 (ref $@moonbitlang/core/builtin.StringBuilder))
 (call $@moonbitlang/core/builtin.Logger::$default_impl::write_substring|@moonbitlang/core/builtin.StringBuilder|
  ...
  (local.get $*param/443)
  (local.get $*param/444)))
(func $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_string.dyncall_as_@moonbitlang/core/builtin.Logger (type $@moonbitlang/core/builtin.Logger.method_0) (param $*obj/440 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/439 (ref $moonbit.string)) (result i32)
...
(start $*init*/2)
(func $*init*/2
 (global.set $username/moonbit_examples/cmd/hof.*init*.double|2
  (struct.new $<Int>=>Int
   (ref.func $username/moonbit_examples/cmd/hof.*init*.double|2.dyncall)))
 (global.set $username/moonbit_examples/cmd/hof.*init*.square|4
  (struct.new $<Int>=>Int
   ...
   (call $moonbit.add_string
    ...
    (call $@moonbitlang/core/builtin.Show::$default_impl::to_string|Int|
     (call $username/moonbit_examples/cmd/hof.apply
      (ref.as_non_null
       (global.get $username/moonbit_examples/cmd/hof.*init*.double|2))
      (i32.const 5))))))
 (drop
  (call $moonbitlang/core/builtin.println|String|
   (call $moonbit.add_string
    ...
    (call $@moonbitlang/core/builtin.Show::$default_impl::to_string|Int|
     (call $username/moonbit_examples/cmd/hof.apply
      (ref.as_non_null
       (global.get $username/moonbit_examples/cmd/hof.*init*.square|4))
      (i32.const 5)))))))
