...
(func $@moonbitlang/core/builtin.Logger::$default_impl::write_substring|@moonbitlang/core/builtin.StringBuilder| (param $self/172 (ref $@moonbitlang/core/builtin.StringBuilder)) (param $value/175 (ref $moonbit.string)) (param $start/176 i32) (param $len/177 i32) (result i32)
 ...
 (local $tag/471 i32)
 (local.get $self/172)
 (block $outer/470 (result (ref $StringView))
...
(func $Bytes::to_unchecked_string.inner (param $self/26 (ref $moonbit.bytes)) (param $offset/30 i32) (param $length/28 i64) (result (ref $moonbit.string))
 ...
 (if (result (ref $moonbit.string))
  ...
  (else
   (unreachable))))
(func $moonbitlang/core/builtin.unsafe_sub_string (param $*param/450 (ref $moonbit.bytes)) (param $*param/451 i32) (param $*param/452 i32) (result (ref $moonbit.string))
...
(func $moonbitlang/core/abort.abort|Unit| (param $msg/1 (ref $moonbit.string)) (result i32)
 (unreachable))
(func $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_char.dyncall_as_@moonbitlang/core/builtin.Logger (type $@moonbitlang/core/builtin.Logger.method_3) (param $*obj/466 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/465 i32) (result i32)
  ...
  (local.tee $*self/464
   (struct.get $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger 4
    (ref.cast (ref $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger)
     (local.get $*obj/466))))
  (local.get $*param/465)))
(func $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_view.dyncall_as_@moonbitlang/core/builtin.Logger (type $@moonbitlang/core/builtin.Logger.method_2) (param $*obj/463 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/462 (ref $StringView)) (result i32)
  ...
  (local.tee $*self/461
   (struct.get $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger 4
    (ref.cast (ref $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger)
     (local.get $*obj/463))))
  (local.get $*param/462)))
(func $@moonbitlang/core/builtin.Logger::$default_impl::write_substring.dyncall_as_@moonbitlang/core/builtin.Logger|@moonbitlang/core/builtin.StringBuilder| (type $@moonbitlang/core/builtin.Logger.method_1) (param $*obj/460 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/457 (ref $moonbit.string)) (param $*param/458 i32) (param $*param/459 i32) (result i32)
 ...
 (call $@moonbitlang/core/builtin.Logger::$default_impl::write_substring|@moonbitlang/core/builtin.StringBuilder|
  ...
  (local.get $*param/458)
  (local.get $*param/459)))
(func $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_string.dyncall_as_@moonbitlang/core/builtin.Logger (type $@moonbitlang/core/builtin.Logger.method_0) (param $*obj/455 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/454 (ref $moonbit.string)) (result i32)
