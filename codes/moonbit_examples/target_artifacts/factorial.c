...
int32_t $username$moonbit_examples$cmd$factorial$factorial(int32_t n$290);
...
int32_t $username$moonbit_examples$cmd$factorial$factorial(int32_t n$290) {
  ...
  while (1) {
    if (i$289 <= n$290) {
      int32_t _tmp$799 = result$288;
      int32_t _tmp$800;
      result$288 = _tmp$799 * i$289;
      _tmp$800 = i$289 + 1;
      i$289 = _tmp$800;
      continue;
    }
...
int32_t $$moonbitlang$core$builtin$Show$$$moonbitlang$core$builtin$SourceLocRepr$$output(
  ...
  switch (accept_state$254) {
    case 0: {
      ...
      int32_t _tmp$765;
      int64_t _tmp$764;
      struct moonbit_result_0 _tmp$851;
      void* Some$762;
      ...
      moonbit_incref(_data$250);
      _tmp$849 = $String$$sub(_data$250, _tmp$768, _tmp$769);
      if (_tmp$849.tag) {
        struct $StringView const _ok$773 = _tmp$849.data.ok;
        package_name$260 = _ok$773;
      } else {
        void* const _err$774 = _tmp$849.data.err;
      ...
      _tmp$851 = $String$$sub(_data$250, _tmp$763, _tmp$764);
      if (_tmp$851.tag) {
        struct $StringView const _ok$766 = _tmp$851.data.ok;
        module_name$263 = _ok$766;
      } else {
        void* const _err$767 = _tmp$851.data.err;
...
int32_t $$moonbitlang$core$builtin$Logger$$$default_impl$$write_substring$0(
  ...
  struct moonbit_result_0 _tmp$859 =
    $String$$sub$inner(value$157, start$158, _tmp$621);
  if (_tmp$859.tag) {
    struct $StringView const _ok$623 = _tmp$859.data.ok;
    _tmp$620 = _ok$623;
  } else {
    void* const _err$624 = _tmp$859.data.err;
...
struct moonbit_result_0 $String$$sub$inner(
  ...
  if (start$147 >= 0 && start$147 <= end$143 && end$143 <= len$141) {
    ...
    if (end$143 < len$141) {
      ...
      _if_result$862 = 56320 <= _p$387 && _p$387 <= 57343;
    } else {
      _if_result$862 = 0;
    }
    if (_if_result$862) {
...
struct $$moonbitlang$core$builtin$SourceLocRepr* $$moonbitlang$core$builtin$SourceLocRepr$$parse(
  ...
  switch (accept_state$53) {
    case 0: {
      ...
      int32_t _tmp$515;
      int64_t _tmp$514;
      struct moonbit_result_0 _tmp$897;
      struct $$moonbitlang$core$builtin$SourceLocRepr* _block$898;
      moonbit_incref(_data$49);
      _tmp$887 = $String$$sub(_data$49, _tmp$547, _tmp$548);
      if (_tmp$887.tag) {
        struct $StringView const _ok$552 = _tmp$887.data.ok;
        start_line$69 = _ok$552;
      } else {
        void* const _err$553 = _tmp$887.data.err;
      ...
      moonbit_incref(_data$49);
      _tmp$889 = $String$$sub(_data$49, _tmp$540, _tmp$541);
      if (_tmp$889.tag) {
        struct $StringView const _ok$545 = _tmp$889.data.ok;
        start_column$72 = _ok$545;
      } else {
        void* const _err$546 = _tmp$889.data.err;
      ...
      moonbit_incref(_data$49);
      _tmp$891 = $String$$sub(_data$49, _tmp$534, _tmp$535);
      if (_tmp$891.tag) {
        struct $StringView const _ok$538 = _tmp$891.data.ok;
        pkg$75 = _ok$538;
      } else {
        void* const _err$539 = _tmp$891.data.err;
      ...
      moonbit_incref(_data$49);
      _tmp$893 = $String$$sub(_data$49, _tmp$527, _tmp$528);
      if (_tmp$893.tag) {
        struct $StringView const _ok$532 = _tmp$893.data.ok;
        filename$78 = _ok$532;
      } else {
        void* const _err$533 = _tmp$893.data.err;
      ...
      moonbit_incref(_data$49);
      _tmp$895 = $String$$sub(_data$49, _tmp$520, _tmp$521);
      if (_tmp$895.tag) {
        struct $StringView const _ok$525 = _tmp$895.data.ok;
        end_line$81 = _ok$525;
      } else {
        void* const _err$526 = _tmp$895.data.err;
      ...
      _tmp$897 = $String$$sub(_data$49, _tmp$513, _tmp$514);
      if (_tmp$897.tag) {
        struct $StringView const _ok$518 = _tmp$897.data.ok;
        end_column$84 = _ok$518;
      } else {
        void* const _err$519 = _tmp$897.data.err;
      ...
      Moonbit_object_header(_block$898)->meta
      = Moonbit_make_regular_object_header(
        offsetof(struct $$moonbitlang$core$builtin$SourceLocRepr, $0_0) >> 2,
          6,
          0
      );
      _block$898->$0_0 = pkg$75.$0;
      _block$898->$0_1 = pkg$75.$1;
      _block$898->$0_2 = pkg$75.$2;
      _block$898->$1_0 = filename$78.$0;
      _block$898->$1_1 = filename$78.$1;
      _block$898->$1_2 = filename$78.$2;
      _block$898->$2_0 = start_line$69.$0;
      _block$898->$2_1 = start_line$69.$1;
      _block$898->$2_2 = start_line$69.$2;
      _block$898->$3_0 = start_column$72.$0;
      _block$898->$3_1 = start_column$72.$1;
      _block$898->$3_2 = start_column$72.$2;
      _block$898->$4_0 = end_line$81.$0;
      _block$898->$4_1 = end_line$81.$1;
      _block$898->$4_2 = end_line$81.$2;
      _block$898->$5_0 = end_column$84.$0;
      _block$898->$5_1 = end_column$84.$1;
      _block$898->$5_2 = end_column$84.$2;
      return _block$898;
      break;
    }
    default: {
...
moonbit_string_t $Bytes$$to_unchecked_string$inner(
  ...
  if (offset$24 >= 0) {
    if (length$21 >= 0) {
      ...
      _if_result$900 = _tmp$475 <= len$19;
    } else {
      _if_result$900 = 0;
    }
  } else {
...
struct $$moonbitlang$core$builtin$StringBuilder* $$moonbitlang$core$builtin$StringBuilder$$new$inner(
  ...
  struct $$moonbitlang$core$builtin$StringBuilder* _block$901;
  if (size_hint$17 < 1) {
    initial$16 = 1;
  } else {
...
int main(int argc, char** argv) {
  ...
  moonbit_init();
  _tmp$457 = $$moonbitlang$core$builtin$Show$$$default_impl$$to_string$0(5);
  _tmp$456
  = moonbit_add_string(
    (moonbit_string_t)moonbit_string_literal_8.data, _tmp$457
  );
  _tmp$453
  = moonbit_add_string(
    _tmp$456, (moonbit_string_t)moonbit_string_literal_9.data
  );
  _tmp$455 = $username$moonbit_examples$cmd$factorial$factorial(5);
  _tmp$454
  = $$moonbitlang$core$builtin$Show$$$default_impl$$to_string$0(
    _tmp$455
  );
  _tmp$452 = moonbit_add_string(_tmp$453, _tmp$454);
