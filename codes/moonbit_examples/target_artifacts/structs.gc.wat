...
(func $@username/moonbit_examples/cmd/structs.User::display (param $self/318 (ref $User)) (result (ref $moonbit.string))
 (call $moonbit.add_string
  ...
  (call $moonbit.string_literal
   ...
   (i32.const 0)
   (i32.const 1))))
(func $@username/moonbit_examples/cmd/structs.User::new (param $id/315 i32) (param $name/316 (ref $moonbit.string)) (param $email/317 (ref $moonbit.string)) (result (ref $User))
 (struct.new $User
  (local.get $id/315)
  (local.get $name/316)
  (local.get $email/317)))
...
(func $@moonbitlang/core/builtin.Show::@moonbitlang/core/builtin.SourceLocRepr::output (param $self/299 (ref $@moonbitlang/core/builtin.SourceLocRepr)) (param $logger/312 (ref $@moonbitlang/core/builtin.Logger)) (result i32)
 ...
 (local $*bind/478 (ref $@moonbitlang/core/builtin.Logger))
 (local $*bind/479 (ref $@moonbitlang/core/builtin.Logger))
...
(func $@moonbitlang/core/builtin.Logger::$default_impl::write_substring|@moonbitlang/core/builtin.StringBuilder| (param $self/172 (ref $@moonbitlang/core/builtin.StringBuilder)) (param $value/175 (ref $moonbit.string)) (param $start/176 i32) (param $len/177 i32) (result i32)
 ...
 (local $*bind/477 (ref $moonbit.enum))
 (local $tag/481 i32)
 (local.get $self/172)
...
(func $Bytes::to_unchecked_string.inner (param $self/26 (ref $moonbit.bytes)) (param $offset/30 i32) (param $length/28 i64) (result (ref $moonbit.string))
 ...
 (if (result (ref $moonbit.string))
  ...
  (else
   (unreachable))))
(func $moonbitlang/core/builtin.unsafe_sub_string (param $*param/460 (ref $moonbit.bytes)) (param $*param/461 i32) (param $*param/462 i32) (result (ref $moonbit.string))
...
(func $moonbitlang/core/abort.abort|Unit| (param $msg/1 (ref $moonbit.string)) (result i32)
 (unreachable))
(func $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_char.dyncall_as_@moonbitlang/core/builtin.Logger (type $@moonbitlang/core/builtin.Logger.method_3) (param $*obj/476 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/475 i32) (result i32)
 (local $*self/474 (ref $@moonbitlang/core/builtin.StringBuilder))
  ...
  (local.tee $*self/474
   (struct.get $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger 4
    (ref.cast (ref $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger)
     (local.get $*obj/476))))
  (local.get $*param/475)))
(func $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_view.dyncall_as_@moonbitlang/core/builtin.Logger (type $@moonbitlang/core/builtin.Logger.method_2) (param $*obj/473 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/472 (ref $StringView)) (result i32)
  ...
  (local.tee $*self/471
   (struct.get $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger 4
    (ref.cast (ref $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger)
     (local.get $*obj/473))))
  (local.get $*param/472)))
(func $@moonbitlang/core/builtin.Logger::$default_impl::write_substring.dyncall_as_@moonbitlang/core/builtin.Logger|@moonbitlang/core/builtin.StringBuilder| (type $@moonbitlang/core/builtin.Logger.method_1) (param $*obj/470 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/467 (ref $moonbit.string)) (param $*param/468 i32) (param $*param/469 i32) (result i32)
 (local $*self/466 (ref $@moonbitlang/core/builtin.StringBuilder))
 (call $@moonbitlang/core/builtin.Logger::$default_impl::write_substring|@moonbitlang/core/builtin.StringBuilder|
  ...
  (local.get $*param/468)
  (local.get $*param/469)))
(func $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_string.dyncall_as_@moonbitlang/core/builtin.Logger (type $@moonbitlang/core/builtin.Logger.method_0) (param $*obj/465 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/464 (ref $moonbit.string)) (result i32)
 (local $*self/463 (ref $@moonbitlang/core/builtin.StringBuilder))
