...
(func $@username/moonbit_examples/cmd/structs.User::display (param $self/291 (ref $User)) (result (ref $moonbit.string))
 (call $moonbit.add_string
  ...
  (call $moonbit.string_literal
   ...
   (i32.const 0)
   (i32.const 1))))
(func $@username/moonbit_examples/cmd/structs.User::new (param $id/288 i32) (param $name/289 (ref $moonbit.string)) (param $email/290 (ref $moonbit.string)) (result (ref $User))
 (struct.new $User
  (local.get $id/288)
  (local.get $name/289)
  (local.get $email/290)))
...
(func $@moonbitlang/core/builtin.Show::@moonbitlang/core/builtin.SourceLocRepr::output (param $self/249 (ref $@moonbitlang/core/builtin.SourceLocRepr)) (param $logger/285 (ref $@moonbitlang/core/builtin.Logger)) (result i32)
 ...
 (local $*p/430 i32)
 (local $*p/433 i32)
 (local $*bind/466 (ref $@moonbitlang/core/builtin.Logger))
 (local $*bind/467 (ref $@moonbitlang/core/builtin.Logger))
 (local $*bind/468 (ref $moonbit.enum))
 (local $*bind/469 (ref $moonbit.enum))
 (local $tag/475 i32)
 (local $tag/477 i32)
 ...
 (local.set $tag_0/257
  (i32.const -1))
 (block $outer/470 (result (ref $<StringView*Option<StringView>>))
  (block $join:259
   (loop $loop:267 (result (ref $<StringView*Option<StringView>>))
    (if (result (ref $<StringView*Option<StringView>>))
     (i32.lt_s
      ...
      (local.get $*end/252))
     (then
      (block $outer/471 (result (ref $<StringView*Option<StringView>>))
       (block $join:266
        (local.set $*p/409
         (local.get $*cursor/253))
              ...
              (loop $loop:270 (result (ref $<StringView*Option<StringView>>))
               ...
               (if (result (ref $<StringView*Option<StringView>>))
                (i32.lt_s
                 ...
                 (local.get $*end/252))
                (then
                 (block $outer/472 (result (ref $<StringView*Option<StringView>>))
                  (block $join:269
                   (local.set $*p/412
                    (local.get $*cursor/253))
                         ...
                         (loop $loop:273 (result (ref $<StringView*Option<StringView>>))
                          (if (result (ref $<StringView*Option<StringView>>))
                           (i32.lt_s
                            ...
                            (local.get $*end/252))
                           (then
                            (block $outer/473 (result (ref $<StringView*Option<StringView>>))
                             (block $join:272
                              (local.set $*p/415
                               (local.get $*cursor/253))
  ...
  (if (result (ref $<StringView*Option<StringView>>))
   (i32.eq
    ...
    (i32.const 0))
   (then
    (block $outer/476 (result (ref $StringView))
    ...
    (block $outer/474 (result (ref $StringView))
...
(func $@moonbitlang/core/builtin.Logger::$default_impl::write_substring|@moonbitlang/core/builtin.StringBuilder| (param $self/154 (ref $@moonbitlang/core/builtin.StringBuilder)) (param $value/157 (ref $moonbit.string)) (param $start/158 i32) (param $len/159 i32) (result i32)
 ...
 (local $*bind/465 (ref $moonbit.enum))
 (local $tag/479 i32)
 (local.get $self/154)
 (block $outer/478 (result (ref $StringView))
...
(func $@moonbitlang/core/builtin.SourceLocRepr::parse (param $repr/48 (ref $moonbit.string)) (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
 ...
 (local $*bind/460 (ref $moonbit.enum))
 (local $*bind/461 (ref $moonbit.enum))
 (local $*bind/462 (ref $moonbit.enum))
 (local $*bind/463 (ref $moonbit.enum))
 (local $*bind/464 (ref $moonbit.enum))
 (local $tag/507 i32)
 (local $tag/509 i32)
 (local $tag/511 i32)
 (local $tag/513 i32)
   ...
   (block $outer/482 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
    (block $join:90
     (block $outer/483 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
      (block $join:94
       (block $switch_int/494 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
        (block $switch_default/495
         (block $switch_int_1/497
          (block $switch_int_7/503
           (block $switch_int_6/502
            (block $switch_int_5/501
             (block $switch_int_4/500
              (block $switch_int_8/504
               (block $switch_int_0/496
                (block $switch_int_2/498
                 (block $switch_int_3/499
                 ...
                 (if (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
                  (i32.lt_s
                   ...
                   (local.get $*end/51))
                  (then
                   (block $outer/484 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
                    (block $join:95
                     (local.set $*p/340
                      (local.get $*cursor/52))
                          ...
                          (else
                           ...
                           (if (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
                            (i32.lt_s
                             ...
                             (local.get $*end/51))
                            (then
                             (block $outer/485 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
                              (block $join:97
                               (local.set $*p/343
                                (local.get $*cursor/52))
                ...
                (if (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
                 (i32.lt_s
                  ...
                  (local.get $*end/51))
                 (then
                  (block $outer/486 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
                   (block $join:99
                    (local.set $*p/346
                     (local.get $*cursor/52))
               ...
               (if (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
                (i32.lt_s
                 ...
                 (local.get $*end/51))
                (then
                 (block $outer/487 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
                  (block $join:101
                   (local.set $*p/349
                    (local.get $*cursor/52))
             ...
             (if (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
              (i32.lt_s
               ...
               (local.get $*end/51))
              (then
               (block $outer/488 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
                (block $join:104
                 (local.set $*p/355
                  (local.get $*cursor/52))
                      ...
                      (else
                       ...
                       (if (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
                        (i32.lt_s
                         ...
                         (local.get $*end/51))
                        (then
                         (block $outer/489 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
                          (block $join:106
                           (local.set $*p/358
                            (local.get $*cursor/52))
                                ...
                                (else
                                 ...
                                 (if (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
                                  (i32.lt_s
                                   ...
                                   (local.get $*end/51))
                                  (then
                                   (block $outer/490 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
                                    (block $join:108
                                     (local.set $*p/361
                                      (local.get $*cursor/52))
            ...
            (if (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
             (i32.lt_s
              ...
              (local.get $*end/51))
             (then
              (block $outer/491 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
               (block $join:110
                (local.set $*p/364
                 (local.get $*cursor/52))
           ...
           (if (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
            (i32.lt_s
             ...
             (local.get $*end/51))
            (then
             (block $outer/492 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
              (block $join:112
               (local.set $*p/367
                (local.get $*cursor/52))
         ...
         (if (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
          (i32.lt_s
           ...
           (local.get $*end/51))
          (then
           (block $outer/493 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
            (block $join:115
             (local.set $*p/373
              (local.get $*cursor/52))
    ...
    (if (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
     (i32.lt_s
      ...
      (local.get $*end/51))
     (then
      (block $outer/505 (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
       (block $join:91
        (local.set $*p/376
         (local.get $*cursor/52))
 ...
 (if (result (ref $@moonbitlang/core/builtin.SourceLocRepr))
  (i32.eq
   ...
   (i32.const 0))
  (then
   (block $outer/516 (result (ref $StringView))
   ...
   (block $outer/514 (result (ref $StringView))
   ...
   (block $outer/512 (result (ref $StringView))
    ...
    (unreachable))
   (local.set $pkg/75)
   (block $outer/510 (result (ref $StringView))
   ...
   (block $outer/508 (result (ref $StringView))
...
(func $Bytes::to_unchecked_string.inner (param $self/20 (ref $moonbit.bytes)) (param $offset/24 i32) (param $length/22 i64) (result (ref $moonbit.string))
 ...
 (if (result (ref $moonbit.string))
  ...
  (else
   (unreachable))))
(func $moonbitlang/core/builtin.unsafe_sub_string (param $*param/442 (ref $moonbit.bytes)) (param $*param/443 i32) (param $*param/444 i32) (result (ref $moonbit.string))
...
(func $moonbitlang/core/abort.abort|Unit| (param $msg/1 (ref $moonbit.string)) (result i32)
 (unreachable))
(func $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_char.dyncall_as_@moonbitlang/core/builtin.Logger (type $@moonbitlang/core/builtin.Logger.method_3) (param $*obj/458 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/457 i32) (result i32)
 (local $*self/456 (ref $@moonbitlang/core/builtin.StringBuilder))
  ...
  (local.tee $*self/456
   (struct.get $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger 4
    (ref.cast (ref $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger)
     (local.get $*obj/458))))
  (local.get $*param/457)))
(func $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_view.dyncall_as_@moonbitlang/core/builtin.Logger (type $@moonbitlang/core/builtin.Logger.method_2) (param $*obj/455 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/454 (ref $StringView)) (result i32)
 (local $*self/453 (ref $@moonbitlang/core/builtin.StringBuilder))
 (call $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_view
  (local.tee $*self/453
   (struct.get $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger 4
    (ref.cast (ref $@moonbitlang/core/builtin.StringBuilder.as_@moonbitlang/core/builtin.Logger)
     (local.get $*obj/455))))
  (local.get $*param/454)))
(func $@moonbitlang/core/builtin.Logger::$default_impl::write_substring.dyncall_as_@moonbitlang/core/builtin.Logger|@moonbitlang/core/builtin.StringBuilder| (type $@moonbitlang/core/builtin.Logger.method_1) (param $*obj/452 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/449 (ref $moonbit.string)) (param $*param/450 i32) (param $*param/451 i32) (result i32)
 (local $*self/448 (ref $@moonbitlang/core/builtin.StringBuilder))
 (call $@moonbitlang/core/builtin.Logger::$default_impl::write_substring|@moonbitlang/core/builtin.StringBuilder|
  ...
  (local.get $*param/450)
  (local.get $*param/451)))
(func $@moonbitlang/core/builtin.Logger::@moonbitlang/core/builtin.StringBuilder::write_string.dyncall_as_@moonbitlang/core/builtin.Logger (type $@moonbitlang/core/builtin.Logger.method_0) (param $*obj/447 (ref $@moonbitlang/core/builtin.Logger)) (param $*param/446 (ref $moonbit.string)) (result i32)
 (local $*self/445 (ref $@moonbitlang/core/builtin.StringBuilder))
