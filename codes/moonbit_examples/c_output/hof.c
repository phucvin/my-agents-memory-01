...
int32_t $username$moonbit_examples$cmd$hof$_init$2a$$square$7c$4$dyncall(
  struct $$3c$Int$3e$$3d$$3e$Int* _env$925,
  int32_t x$318
);

int32_t $username$moonbit_examples$cmd$hof$_init$2a$$double$7c$2$dyncall(
  struct $$3c$Int$3e$$3d$$3e$Int* _env$924,
  int32_t x$317
);
...
int32_t $username$moonbit_examples$cmd$hof$apply(
  struct $$3c$Int$3e$$3d$$3e$Int* f$315,
  int32_t x$316
);
...
int32_t $username$moonbit_examples$cmd$hof$_init$2a$$square$7c$4$dyncall(
  ...
  return $username$moonbit_examples$cmd$hof$_init$2a$$square$7c$4(x$318);
}
...
int32_t $username$moonbit_examples$cmd$hof$_init$2a$$double$7c$2$dyncall(
  ...
  return $username$moonbit_examples$cmd$hof$_init$2a$$double$7c$2(x$317);
}
  ...
  if (start_offset$278 >= 0 && start_offset$278 <= end_offset$279) {
    ...
    while (1) {
      ...
      if (_tmp$872 < end_offset$279) {
        ...
        _if_result$1007 = _tmp$871 < n$282;
      } else {
        _if_result$1007 = 0;
      }
      if (_if_result$1007) {
    ...
    if (_tmp$878 < n$282) {
      ...
      _if_result$1008 = _tmp$877 >= end_offset$279;
    }
    if (_if_result$1008) {
      return 4294967296ll;
    } else {
...
int64_t $String$$offset_of_nth_char_backward(
  ...
  while (1) {
    ...
    if (_tmp$861 >= start_offset$273) {
      ...
      _if_result$1010 = _tmp$860 < n$274;
    } else {
      _if_result$1010 = 0;
    }
    if (_if_result$1010) {
  ...
  if (_tmp$869 < n$274) {
    ...
    _if_result$1011 = _tmp$868 < start_offset$273;
  }
  if (_if_result$1011) {
    return 4294967296ll;
  } else {
...
int32_t $String$$char_length_ge$inner(
  ...
  while (1) {
    if (index$263 < end_offset$259 && count$264 < len$265) {
      ...
      int32_t _if_result$1013;
      int32_t _tmp$858;
      int32_t _tmp$859;
      if (55296 <= c1$266 && c1$266 <= 56319) {
        int32_t _tmp$854 = index$263 + 1;
        _if_result$1013 = _tmp$854 < end_offset$259;
      } else {
        _if_result$1013 = 0;
      }
      if (_if_result$1013) {
...
int32_t $$moonbitlang$core$builtin$Logger$$$default_impl$$write_substring$0(
  ...
  struct moonbit_result_0 _tmp$1021 =
    $String$$sub$inner(value$175, start$176, _tmp$742);
  if (_tmp$1021.tag) {
    struct $StringView const _ok$744 = _tmp$1021.data.ok;
    _tmp$741 = _ok$744;
  } else {
    void* const _err$745 = _tmp$1021.data.err;
                  ...
                  if (_tmp$689 < _tmp$690) {
                    ...
                    if (_bind$142 == 0) {
                      ...
                      if (_filename_end$140 > _tmp$693) {
                        ...
                        struct $$moonbitlang$core$builtin$SourceLocRepr* _block$1031 =
                          (struct $$moonbitlang$core$builtin$SourceLocRepr*)moonbit_malloc(
                            sizeof(
                              struct $$moonbitlang$core$builtin$SourceLocRepr
                            )
                          );
                        Moonbit_object_header(_block$1031)->meta
                        = Moonbit_make_regular_object_header(
                          offsetof(
                            struct $$moonbitlang$core$builtin$SourceLocRepr,
                              $0_0
                        ...
                        _block$1031->$0_0 = pkg$123.$0;
                        _block$1031->$0_1 = pkg$123.$1;
                        _block$1031->$0_2 = pkg$123.$2;
                        _block$1031->$1_0 = filename$147.$0;
                        _block$1031->$1_1 = filename$147.$1;
                        _block$1031->$1_2 = filename$147.$2;
                        _block$1031->$2_0 = _start_line$145.$0;
                        _block$1031->$2_1 = _start_line$145.$1;
                        _block$1031->$2_2 = _start_line$145.$2;
                        _block$1031->$3_0 = _start_column$146.$0;
                        _block$1031->$3_1 = _start_column$146.$1;
                        _block$1031->$3_2 = _start_column$146.$2;
                        _block$1031->$4_0 = _end_line$131.$0;
                        _block$1031->$4_1 = _end_line$131.$1;
                        _block$1031->$4_2 = _end_line$131.$2;
                        _block$1031->$5_0 = _end_column$132.$0;
                        _block$1031->$5_1 = _end_column$132.$1;
                        _block$1031->$5_2 = _end_column$132.$2;
                        return _block$1031;
                      } else {
...
struct $$3c$StringView$2a$StringView$3e$* $moonbitlang$core$builtin$parse$parse_loc$7c$1101(
  ...
  if (_bind$111 == 4294967296ll) {
    ...
    if (_i$114 > 0) {
      ...
      _if_result$1032 = _tmp$672 < _tmp$673;
    } else {
      _if_result$1032 = 0;
    }
    if (_if_result$1032) {
...
struct $StringView $StringView$$view$inner(
  ...
  if (start_offset$110 >= 0) {
    if (start_offset$110 <= end_offset$106) {
      ...
      _if_result$1033 = end_offset$106 <= _tmp$662;
    } else {
      _if_result$1033 = 0;
    }
  } else {
        ...
        if (_tmp$632 >= 0) {
          ...
          while (1) {
            ...
            if (_tmp$637 >= 0) {
              ...
              _if_result$1036 = _tmp$633 != needle_first$98;
            } else {
              _if_result$1036 = 0;
            }
            if (_if_result$1036) {
        ...
        if (_tmp$574 <= forward_len$75) {
          ...
          while (1) {
            ...
            if (_tmp$579 <= forward_len$75) {
              ...
              _if_result$1043 = _tmp$575 != needle_first$74;
            } else {
              _if_result$1043 = 0;
            }
            if (_if_result$1043) {
...
moonbit_string_t $Bytes$$to_unchecked_string$inner(
  ...
  if (offset$30 >= 0) {
    if (length$27 >= 0) {
      ...
      _if_result$1049 = _tmp$501 <= len$25;
    } else {
      _if_result$1049 = 0;
    }
  } else {
...
struct $$moonbitlang$core$builtin$StringBuilder* $$moonbitlang$core$builtin$StringBuilder$$new$inner(
  ...
  struct $$moonbitlang$core$builtin$StringBuilder* _block$1050;
  if (size_hint$23 < 1) {
    initial$22 = 1;
  } else {
...
int main(int argc, char** argv) {
  ...
  _tmp$470
  = moonbit_add_string(
    (moonbit_string_t)moonbit_string_literal_17.data, _tmp$471
  );
  ...
  _tmp$473
  = moonbit_add_string(
    (moonbit_string_t)moonbit_string_literal_18.data, _tmp$474
  );
  $moonbitlang$core$builtin$println$0(_tmp$473);
  return 0;
}