...
int32_t $username$moonbit_examples$cmd$fib$fib(int32_t n$315);
...
int32_t $username$moonbit_examples$cmd$fib$fib(int32_t n$315) {
  if (n$315 <= 1) {
    ...
    int32_t _tmp$921 = $username$moonbit_examples$cmd$fib$fib(_tmp$924);
    int32_t _tmp$923 = n$315 - 2;
    int32_t _tmp$922 = $username$moonbit_examples$cmd$fib$fib(_tmp$923);
...
int main(int argc, char** argv) {
  ...
  _tmp$470 = $username$moonbit_examples$cmd$fib$fib(10);
  _tmp$469
